...
|Topic|Image|Video|Description|
|:----:|:----:|:----:|:----:|
| [Curved-Lane-Detection](https://github.com/murtazahassan/Robot-Arm-Gesture-Control)| <img src="https://github.com/murtazahassan/Robot-Arm-Gesture-Control/blob/master/Images/4.PNG" width="600" height="150" />  |[Watch Now](https://youtu.be/gmz7eOB-tCg)     | This is a step by step guide on how to build a Robot Arm / Hand that can be controlled with gestures. </br> |
